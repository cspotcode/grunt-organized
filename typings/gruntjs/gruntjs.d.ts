...
declare module grunt {
    ...
    module task {
        ...
        interface CommonTaskModule {
             ...
             */
            registerTask(taskName: string, taskList: string[]): TaskModule
            registerTask(taskName: string, taskDescription: string, taskList: string[]): TaskModule
             ...
             */
            registerTask(taskName: string, taskDescription: string, taskFunction: Function): TaskModule
            registerTask(taskName: string, taskFunction: Function): TaskModule
